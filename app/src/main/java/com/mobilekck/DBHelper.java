...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "BazisMobileDb";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_CONTACTS + "(" + KEY_ID
                + " integer primary key," + KEY_IIN + " text," + KEY_NAME + " text," + KEY_SURNAME + " text," + KEY_LASTNAME + " text," + KEY_ADRESS + " text" + ")");
